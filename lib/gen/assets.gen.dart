...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [battle, home, profile, repeat];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/Group 330.png
  AssetGenImage get group330 =>
      const AssetGenImage('assets/images/Group 330.png');
